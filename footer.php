<div class="rakutentv-news-footer">
  <div class="rakutentv-news-footer-inr">

    <div class="rakutentv-news-footer-main">
      <div class="rakutentv-news-footer-main-inr">
        <div class="rakutentv-news-footer-main-logo">
          <a href="./">
            <span>
              <svg viewBox="0 0 182 18" xmlns="http://www.w3.org/2000/svg">
                ...
                c0-1.3-0.7-2.4-2-3.1c-0.7-0.4-1.6-0.7-3.1-1.1c-0.9-0.3-1.3-0.6-1.3-1.2c0-0.6,0.6-1,1.4-1c0.9,0,1.6,0.4,2.5,1.3L179,5.7z" class="svglogo"/>
              </svg>
            </span>
          </a>
        </div>
    ...
    <nav>
      <div class="rakutentv-news-footer-nav">
        <div class="rakutentv-news-footer-nav-inr"> 
          <ul>
            <li><a href="../"><span>洋画</span></a></li>
            <li><a href="../"><span>邦画</span></a></li>
            <li><a href="../"><span>海外ドラマ</span></a></li>
            <li><a href="../"><span>中国・台湾ドラマ</span></a></li>
            <li><a href="../"><span>国内ドラマ</span></a></li>
            <li><a href="../"><span>韓国ドラマ</span></a></li>
            <li><a href="../"><span>アニメ</span></a></li>
            <li><a href="../"><span>宝塚</span></a></li>
            <li><a href="../"><span>舞台</span></a></li>
            <li><a href="../"><span>バラエティ</span></a></li>
            <li><a href="../"><span>ドキュメンタリー</span></a></li>
          </ul>
        </div>
      </div>
    </nav>

    <div class="rakutentv-news-footer-sns">
      <div class="rakutentv-news-footer-sns-inr"> 
        <ol>
          <li><a href="../"><span><img src="./img/sns/tw.svg" alt=""></span></a></li>
          <li><a href="../"><span><img src="./img/sns/fb.svg" alt=""></span></a></li>
          <li><a href="../"><span><img src="./img/sns/is.svg" alt=""></span></a></li>
          <li><a href="../"><span><img src="./img/sns/ln.svg" alt=""></span></a></li>
          <li><a href="../"><span><img src="./img/sns/yt.svg" alt=""></span></a></li>
        </ol>
      </div>
    </div>

    <div class="rakutentv-news-footer-inc">
      <div class="rakutentv-news-footer-inc-logo">
        <a href="./"><span><img src="./img/rtv_logo.svg" alt="らくてんてぃーびー"></span></a>
      </div>
      <div class="rakutentv-news-footer-inc-inr">
        <ol>
    ...
    <div class="rakutentv-news-footer-copyright">
      <span>Copyright &copy; Rakuten Group, Inc.All Rights Reserved.</span>
    </div>

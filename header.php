<div class="rakutentv-news-header">
  <div class="rakutentv-news-header-inr">

    <div class="rakutentv-news-header-topbar">
      <div class="rakutentv-news-header-topbar-inr">
        <div class="rakutentv-news-header-topbar-text">
          <span>
            Rakuten TVが発信するエンタメ系ニュースサイトです
          </span>
        </div>
        <div class="rakutentv-news-header-topbar-btn">
          <ol>
            <li><a href="https://tv.rakuten.co.jp/" target="_brank"><span>Rakuten TV</span></a></li>
          </ol>
        </div>
      </div>
    </div>

    <div class="rakutentv-news-header-main hdn_elm fix">
      <div class="rakutentv-news-header-main-inr fix">
        <?php include('./search.php') ?>
        <div class="mgn key_elm"><span></span></div>
        <div class="bgr key_elm"><span></span></div>
        <h1 class="rakutentv-news-header-main-logo fix">
          <a href="./">
            <span>
    ...
    <?php if(empty($top)) : ?>
    <nav>
      <div class="rakutentv-news-header-nav">
        <div class="rakutentv-news-header-nav-inr">
          <ul>
            <li><a class="ripple"><span>映画</span></a></li>
            <li><a class="ripple"><span>ドラマ</span></a></li>
            <li><a class="ripple"><span>ライブ</span></a></li>
            <li class="vary"><a class="ripple"><span><img src="./img/rtv_logo.svg" alt="Rakuten TV"></span></a></li>
          </ul>
        </div>
      </div>
    </nav>
